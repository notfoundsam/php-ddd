...
/**
 * Configuration constants for scheduled event processing
 *
 * Similar to OutboxEventConfig but includes STATUS_CANCELLED for events
 * that are canceled before their scheduled time.
 */
final class ScheduledEventConfig
{
    /**
